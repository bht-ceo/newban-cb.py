...
print("")
name = raw_input("Welcome dude...Its Alex CB from Black Hunter Team BHT..Our facebook group:- https://facebook.com/groups/995814744406463")


print('')
name = raw_input('Input your Banner Name : ')
print('')
names = raw_input('Input your NickName : ')
...
echo "
   < ━━━━━━━━━━━━ [★] T E R M U X [★] ━━━━━━━━━━━━ >  " |lolcat
echo
    echo " Member At Black Hunter Team
    ████╗       ██╗     ██╗████████╗
██╔══██╗   ██║     ██║╚══██╔══╝
██████╔╝   ███████║        ██║   CEO:Alex CB
██╔══██╗   ██╔══██║        ██║   
